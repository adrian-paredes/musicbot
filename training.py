...
# se entrenará el algoritmo según un método a escoger 
def obtenerModelo(method,facesData,labels):
	...
	# Se almacena el modelo obtenido en un archivo .xml
	emotion_recognizer.write("modelo"+method+".xml")

# Ruta de la carpeta Data
dataPath = os.getcwd() + '/' + 'Data'

# Ruta de la carpeta según cada emoción
...
# Realizamos el entrenamiento para los 3 métodos
